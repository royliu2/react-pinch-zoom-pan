...
var ReactPinchZoomPan = function (_Component) {
  ...
  _createClass(ReactPinchZoomPan, [{
    ...
    value: function handlePinch() {
      ...
      this.pinchSubscription = pinch.subscribe(function (newObject) {
        if (_this3.state.obj.scale !== newObject.scale) {
          _this3.refreshPinchTimeoutTimer(newObject.scale);
        }
    ...
    value: function refreshPinchTimeoutTimer(newScale) {
      var _this4 = this;
    ...
    value: function pinchStopped() {
      ...
      this.setState({
        ...
        _this5.props.onPinchStop && _this5.props.onPinchStop(_this5.state.obj);
      });
    }
  }, {
    key: 'pinchStarted',
    value: function pinchStarted(newScale) {
      var _this6 = this;

      this.setState({
        isPinching: true
      }, function () {
        var obj = _this6.state.obj;
