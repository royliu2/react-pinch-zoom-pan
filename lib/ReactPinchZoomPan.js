...
var ReactPinchZoomPan = function (_Component) {
  ...
  _createClass(ReactPinchZoomPan, [{
    ...
    value: function handlePinch() {
      ...
      this.pinchSubscription = pinch.subscribe(function (newObject) {
        if (_this3.state.obj.scale !== newObject.scale) {
          _this3.refreshPinchTimeoutTimer(newObject);
        }
    ...
    value: function refreshPinchTimeoutTimer(newObj) {
      var _this4 = this;
      ...
      if (!this.state.isPinching) {
        this.pinchStarted(newObj);
      }

      this.pinchTimeoutTimer = setTimeout(function () {
        return _this4.pinchStopped(newObj);
      }, 500);
    }
  }, {
    key: 'pinchStopped',
    value: function pinchStopped(obj) {
      var _this5 = this;
      ...
      this.setState({
        ...
        _this5.props.onPinchStop && _this5.props.onPinchStop(obj);
      });
    }
  }, {
    key: 'pinchStarted',
    value: function pinchStarted(obj) {
      var _this6 = this;

      this.setState({
        isPinching: true
      }, function () {
        _this6.props.onPinchStart && _this6.props.onPinchStart(obj);
      });
    }
  }, {
    key: 'render',
